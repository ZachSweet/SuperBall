...
class Vector3 {
    ...
    static dot(other1, other2) {
        let xs = other1.elements[0] * other2.elements[0];
        let ys = other1.elements[1] * other2.elements[1];
        let zs = other1.elements[2] * other2.elements[2];
        let d = xs + ys + zs;
        return d;
    }
    ...
    static cross(other1, other2) {
        ...
        let v3 = new Vector3();
        v3.elements[0] = y1*z2 - y2*z1;
        v3.elements[1] = x2*z1 - x1*z2;
        v3.elements[2] = x1*y2 - x2*y1;
...
class Matrix4 {
    ...
    globalRotate = function(angle, x, y, z) {
      var e = new Matrix4().setRotate(angle, x, y, z);
      this.elements[0] = e.elements[0]; this.elements[1] = e.elements[1]; this.elements[2] = e.elements[2];
      this.elements[4] = e.elements[4]; this.elements[5] = e.elements[5]; this.elements[6] = e.elements[6];
      this.elements[8] = e.elements[8]; this.elements[9] = e.elements[9]; this.elements[10] = e.elements[10];
    }
    ...
    setLookAt(eyeX, eyeY, eyeZ, centerX, centerY, centerZ, upX, upY, upZ) {
      ...
      return this.translate(-eyeX, -eyeY, -eyeZ);
		...
		setLookAtArray(eye, center, up) {
      return this.setLookAt(eye[0],eye[1],eye[2], center[0],center[1],center[2], up[0],up[1],up[2]);
    }
